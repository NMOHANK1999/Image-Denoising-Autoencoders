# -*- coding: utf-8 -*-
"""
Created on Sat Nov 25 08:42:44 2023
...
#adding noise, mean of 0 and std_dev of 1
noise_factor = 0.2
x_train_noisy = X_train + noise_factor * numpy.random.normal(loc=0.0, scale=1.0, size=X_train.shape)
x_test_noisy = X_test + noise_factor * numpy.random.normal(loc=0.0, scale=1.0, size=X_test.shape)
x_train_noisy = numpy.clip(x_train_noisy, 0., 1.) #to make sure number is in btw 0 and 1
